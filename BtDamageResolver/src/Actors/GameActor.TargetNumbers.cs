    ...
    public partial class GameActor
    {
        ...
        private async Task<List<TargetNumberUpdate>> UpdateTargetNumbers(IEnumerable<Guid> unitIds)
        {
            ...
            foreach (var unitId in unitIds)
            {
                ...
                {
                    targetNumberUpdates.AddRange(await unitActor.UpdateTargetNumbers(_gameActorState.State.Options));
                }
                else
                {
                    targetNumberUpdates.AddRange(await unitActor.UpdateTargetNumbers(_gameActorState.State.Options, true));
