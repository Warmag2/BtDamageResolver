...
public partial class LogicUnit
{
    ...
    protected virtual List<DamagePacket> ResolveDamagePackets(DamageReport damageReport, Guid damageOwnerId, ILogicUnit target, CombatAction combatAction, int damage)
    {
        ...
        {
            damageReport.Log(new AttackLogEntry(AttackLogEntryType.Information, damageOwnerId, "Heat weapon acts as a cluster weapon against targeted unit"));
