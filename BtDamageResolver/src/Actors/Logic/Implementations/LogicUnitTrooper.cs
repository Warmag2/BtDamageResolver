...
public abstract class LogicUnitTrooper : LogicUnit
{
    ...
    protected LogicUnitTrooper(ILogger<LogicUnitTrooper> logger, GameOptions gameOptions, IMathExpression mathExpression, RepositoryProvider repositoryProvider, IResolverRandom random, UnitEntry unit) : base(logger, gameOptions, mathExpression, repositoryProvider, random, unit)
    {
    }
