...
public class LogicUnitVehicleHover : LogicUnitVehicleGround
{
    ...
    public LogicUnitVehicleHover(ILogger<LogicUnitVehicleHover> logger, GameOptions gameOptions, IMathExpression mathExpression, RepositoryProvider repositoryProvider, IResolverRandom resolverRandom, UnitEntry unit) : base(logger, gameOptions, mathExpression, repositoryProvider, resolverRandom, unit)
    {
    }
